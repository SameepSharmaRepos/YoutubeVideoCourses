package com.example.videoteacher.ui.youtube;
...
public class YoutubeConnector {
    ...
    public static final String KEY = "AIzaSyDI39BoS1zJ9YB511Brb8iTIgtrEr11K2M";

    //Package name of the app that will call the YouTube Data API
    public static final String PACKAGENAME = "com.example.videoteacher";

    //SHA1 fingerprint of APP can be found by double clicking on the app signing report on right tab called gradle
    public static final String SHA1 = "E7:5C:CD:21:F5:46:DB:11:94:0D:30:D3:34:C7:E2:1D:41:89:59:5E";
    ...
    public YoutubeConnector(Context context) {
        ...
        Log.e("ConnectorConstructor>> ", "Yes <<");
        ...
        }).setApplicationName("VideoTeacher").build();
    ...
    private static List<VideoItem> setItemsList(Iterator<SearchResult> iteratorSearchResults) {
        ...
        if (!iteratorSearchResults.hasNext()) {
            Log.e("NoREsults>>"," There aren't any results for your query.");
        }
